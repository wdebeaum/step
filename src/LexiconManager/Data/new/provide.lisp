  ...
  (W::provide
   ...
   (SENSES
    ...
    ((LF-PARENT ONT::supply)
     ...
     (SEM (F::Aspect F::Bounded) (F::Time-span F::Atomic))
     (TEMPL agent-recipient-affected-templ (xp (% w::pp (w::ptype w::with) (W::lf (% ?p (w::class (? x ont::phys-object)))))))
    ...
    ((LF-PARENT ONT::enable)
     ...
     (SEM (F::Aspect F::Bounded) (F::Time-span F::Atomic))
     (TEMPL agent-formal-xp-TEMPL (xp (% W::NP (W::lf (% ?p (w::class (? x ont::situation-root)))))))
     )
    ((LF-PARENT ONT::enable)    ;; 
     (example "provide him with an opportunity")
     (SEM (F::Aspect F::Bounded) (F::Time-span F::Atomic))
     (TEMPL agent-formal-xp-templ (xp (% w::pp (w::ptype w::with) (W::lf (% ?p (w::class (? x ont::situation-root)))))))
     (meta-data :origin calo-ontology :entry-date 20050922 :change-date 20090501 :comments vn2-integration)
     )
