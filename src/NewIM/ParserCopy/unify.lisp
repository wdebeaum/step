;; THIS IS AN EXACT COPY OF PARSER/UNIFY.LISP bUT IN THE IM PACKAGE
...
;;  This function DIFFERS from the Parser version in that it requires the value
;;   to be a substype of the Pattern -- it is not type intersection as the parser uses.


(defun compat (feat v1 patval)
   (declare (optimize (speed 3) (safety 0) (debug 0)))
   (cond ((eq v1 patval) v1)
	 ((subtype feat v1 patval) v1)))
