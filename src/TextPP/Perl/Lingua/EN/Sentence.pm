...
# L. Galescu: abbreviations found in publications
my @PUBLICATIONS = ('Fig', 'Sec', 'Ch', 'cf' );

@ABBREVIATIONS = (@PEOPLE, @ARMY, @INSTITUTES, @COMPANIES, @PLACES, @MONTHS, @MISC, @PUBLICATIONS ); 
