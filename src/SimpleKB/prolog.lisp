...
(defun rename-variables (x)
  ...
  ;; gf: Use gentemp rather than gensym so symbols print nicely
  (sublis (mapcar #'(lambda (var) (cons var (gentemp (string var))))
                  (variables-in x))
          x))
...
(defun prove (goal &optional bindings other-goals)
